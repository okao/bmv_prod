...
const RelatedArticlesMobile = ({article}: {article: any}) => {
  ...
  return (
    <div className='relative mb-8 mt-10 gap-4 rounded-[20px] bg-okaogray-500 p-6 pb-12 dark:bg-slate-800 md:hidden lg:grid-cols-4'>
      <div className="grid gap-y-6 divide-y divide-gray-400 text-center dark:divide-slate-700 ">
        {/* <h6
            className={cn(
        ...
        <div
          className="text-center text-sm text-gray-800 dark:text-slate-500 md:rounded-b-lg md:px-4 md:pb-4 md:text-base md:font-thin md:leading-6 md:tracking-wider"
        >
          For Advertisement and Sponsored Content, please contact us at{" "}
          <a href="mailto:info@breaking.mv"> info@breaking.mv</a>
        </div>
        <div
...
export default RelatedArticlesMobile