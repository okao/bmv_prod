    ...
    <div>
      ...
      <div className="relative grid gap-y-6 overflow-x-auto">
        ...
        <a
          ...
          href="/dv/143700"
        >
          <div className="relative col-span-2 mb-[18px] aspect-[223/157] overflow-hidden rounded-2xl lg:rounded-[20px]">
            <img
          ...
          <div className="rtl col-span-3 my-2 hidden lg:block">
            <h3
              className={cn(
                "line-clamp-4 text-lg font-bold leading-loose opacity-75 transition-all",
                mvRasmee.className
              )}
            >
