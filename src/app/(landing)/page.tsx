          ...
          <div className="md:mt-10">
            <div className="mx-auto md:container">
              <div className="gap-6 md:flex md:flex-row-reverse">
                <div className="rtl bg-okaogray-400 mb-10 dark:bg-slate-900 dark:shadow-lg md:mb-0 md:flex md:w-4/6 md:rounded-lg">
                ...
                <div className="bg-okaogray-500 flex flex-col space-y-4 bg-opacity-50 p-5 dark:bg-slate-900 dark:shadow-lg md:ml-3 md:w-2/6 md:rounded-lg">
                ...
                <div className="grid-cols-1 gap-8 md:grid md:grid-cols-12">
                  <div className="col-span-12 md:col-span-12 md:ml-2">
                    <div className="mb-10 grid grid-cols-1 gap-10 md:grid-cols-3">
                      <a
                        className="bg-okaogray-500 block rounded-lg p-4 dark:z-10 dark:border-gray-100 dark:bg-slate-900 dark:shadow-lg"
                        href="/single"
                      >
                        <div className="relative float-right mb-2 ml-6">
                          <img
                    ...
                    <div className="mt-5 flex items-center justify-center">
                      <button className="ltr border-okaoblue-500 bg-okaogray-300 text-okaoblue-600 hover:border-okaoblue-600 hover:bg-okaoblue-800 relative z-10 flex size-8 items-center justify-center rounded-full border text-xl font-semibold hover:text-white dark:border-slate-600 dark:bg-slate-500 dark:text-slate-600 dark:hover:bg-slate-600 dark:hover:text-white md:size-10">
                        <span>+</span>
                      </button>
                    </div>
                  </div>
            ...
            <div className="rtl mx-auto grid grid-cols-12 gap-8 md:container md:gap-10">
              <a href="/single" className="col-span-12 md:col-span-6 md:py-20">
                <div className="flex h-full flex-col">
                  ...
                  />
                  <div
                    className="bg-okaogray-500 mt-8 w-full pb-10 pt-20 text-center dark:bg-slate-900 dark:bg-opacity-50"
              ...
              >
                <div className="bg-okaogray-400 flex h-full flex-col justify-between bg-opacity-50 dark:bg-slate-800">
                  <div className="p-4">
                    <h2
                      className={cn(
                    ...
                    <p
                      className={cn(
                        "text-okaoblue-700 mt-4 text-center",
                        mvWaheed.className
                      )}
                    >
                      އައިޝާ މުހައްމަދު
                    </p>
                    <div className="border-okaoblue-300 mx-auto mt-8 h-0.5 w-2/3 border-t"></div>
                  </div>
            ...
            <div className="rtl mx-auto md:container">
              <div className="flex items-center space-x-3 space-x-reverse px-4 md:px-0">
                ...
                >
                  ...
                  <span className="bg-okaoblue-500 size-3"></span>
                </h3>
              </div>
          ...
          <div className="mt-10 md:mt-16">
            <div className="rtl mx-auto md:container">
              ...
              >
                ...
                <div className="bg-okaoblue-500 size-3 flex-none"></div>
              ...
              <div className="mt-6 grid grid-cols-5 gap-8">
                ...
                <div className="bg-okaogray-400 col-span-5 space-y-7 p-4 dark:bg-slate-900 md:col-span-2 md:rounded-lg">
