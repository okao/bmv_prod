...
`;async function f(){let{data:e}=await n.query({query:h});return e.articleConnection}let x=i.Ps`
...
`;async function g(){let{data:e}=await n.query({query:x});return e.articleConnection}let p=i.Ps`
query WorldArticles {
  articleConnection(
    orderBy: createdAt_DESC
    first: 4
...
`;async function b(){let{data:e}=await n.query({query:p});return e.articleConnection}i.Ps`
query Article($id: ID!) {
  article(where: {id: $id}) {
    id
    title
