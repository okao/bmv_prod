...
`;async function f(){let{data:e}=await n.query({query:h});return e.articleConnection}let x=r.Ps`
...
`;async function g(){let{data:e}=await n.query({query:x});return e.articleConnection}r.Ps`
query Article($id: ID!) {
  article(where: {id: $id}) {
    id
    title
