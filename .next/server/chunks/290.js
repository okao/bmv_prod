...
`;async function u(){let{data:e}=await n.query({query:m});return e.articleConnection}let h=r.Ps`
...
`;async function f(){let{data:e}=await n.query({query:h});return e.articleConnection}r.Ps`
query Article($id: ID!) {
  article(where: {id: $id}) {
    id
    title
