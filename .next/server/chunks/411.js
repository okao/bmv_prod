...
`;async function g(e){(0,n.revalidatePath)(`/article/${e}`);let{data:t}=await l.query({query:f,variables:{id:e}});return t.article}let x=s.Ps`
...
`;async function p(e="ރިޕޯޓް",t=3){let{data:a}=await l.query({query:x,variables:{name:e,first:t}});return a?.articleConnection}let b=s.Ps`
